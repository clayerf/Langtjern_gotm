...
!BOC
   ...
   call fm%register('precip_ice', 'm/s', 'precipitation_ice', standard_name='', data0d=precip_ice, category='surface')
...
! Variables for homegrown ice module   
   call fm%register('Hice', 'm', 'Ice height', standard_name='Hice', dimensions=(/id_dim_z/), data1d=Hice(1:nlev),category='meanflow')
   call fm%register('h_frazil', 'm', 'Frazil ice gieght', standard_name='FrazilIce', dimensions=(/id_dim_z/), data1d=h_frazil(1:nlev),category='meanflow')
